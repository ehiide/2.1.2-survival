...
{
    FileConfiguration whitelist = FileManager.getInstance().whitelist();
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, String[] args)
    {
        ...
        if (sender instanceof Player)
        {
            ...
            {
                ChatManager.sendNotification(player, "Tylko administracja ma prawo decydowac kto tu moze grac!", ChatManager.NotificationType.ERROR);
                return true;
            }
            ...
            if (length == 0)
                ChatManager.sendMessage(player, Configuration.SERVER_FULL_PREFIX + "#8c8c8cGracze wpisani na whiteliste: #fff203" + whitelist.get("whitelist") + ".");
            else
            {
