...
public class QuestUtil
{
    ...
    static QuestUtil instance = new QuestUtil();

    public static QuestUtil getInstance() { return instance; }

    public Reader getReader(String string) { return new Reader(string); }
